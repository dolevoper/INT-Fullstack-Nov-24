...
function moonlitGrove() {
    ...
    switch (userAction === null || userAction === void 0 ? void 0 : userAction.trim().toLowerCase()) {
        case "1":
            alert("Congrats! You have found a useful axe");
            return forgottenTemple;
        case "2":
            alert("Oops! You have been walking in circles.");
            return moonlitGrove;
        case "3":
            alert(UserNickname + ":/nYour inventory is empty.");
            return moonlitGrove;
        case undefined:
...
function forgottenTemple() {
    var userAction = prompt("The crumbling walls of a long-abandoned temple rise before you. The floor is covered in moss and vine, and faint carvings of gods and beasts can be seen on the stone pillars. A heavy door to the south is sealed with a big lock.\n" +
        "1. Follow the stream ahead towards the distant forest" +
        "2. Use the axe to break the door lock\n" +
        "3. Show inventory");
    switch (userAction === null || userAction === void 0 ? void 0 : userAction.trim().toLowerCase()) {
        case "1":
            alert("Oops! You have been walking the wrong way.");
            return forgottenTemple;
        case "2":
            alert("Your axe broke while opening the lock.\n Be aware, Behind the heavy door there is a mysteriuos key ");
            return enchantedForrestClearing;
        case "3":
            alert(UserNickname + ":/nYou have an axe.");
            return forgottenTemple;
        case undefined:
            var shouldQuit = confirm("Are you sure you want to quit the game?");
