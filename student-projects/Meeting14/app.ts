...
const operation = prompt("Choose an operaion (+ - * /):");
...
const chosenNumber = Number(prompt("Guess a number between 1 and " + max));
...
const chosenNumber1 = Number(prompt("Player 1 - guess a number between 1 and: " + max));
...
if (chosenNumber1 === randomNumber) {
    ...
    const chosenNumber2 = Number(prompt("Player 2 - guess a smaller than " + chosenNumber1));
    if (chosenNumber2 === randomNumber) {
        ...
        const chosenNumber3 = Number(prompt("Player 3- guess a smaller than " + chosenNumber2));
        ...
        const chosenNumber3 = Number(prompt("Player 3 - guess a bigger than " + chosenNumber2));
        if (chosenNumber3 === randomNumber) {
            alert ("Player 3 won! The secret number is: " + randomNumber);
        }
        else if ( chosenNumber3 > randomNumber) {
    ...
    const chosenNumber2 = Number(prompt("Player 2 - guess a bigger than " + chosenNumber1));
    if (chosenNumber2 === randomNumber) {
        alert ("Player 2 won! The secret number is: " + randomNumber);
    }
    else if (chosenNumber2 > randomNumber) {
